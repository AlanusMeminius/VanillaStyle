...
public:
    ...
    void drawContents(const QStyleOption* option, QPainter* painter, const QWidget* widget);
    void drawText(const QStyleOption* option, QPainter* painter, const QWidget* widget);
